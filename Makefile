...
GO_PKG=github.com/nholuongut/prometheus-operator
IMAGE_OPERATOR?=quay.io/nholuongut/prometheus-operator
...
# See https://github.com/nholuongut/prometheus-operator/issues/4355
...
RBAC_MANIFESTS = example/rbac/nholuongut/prometheus-operator-cluster-role.yaml example/rbac/nholuongut/prometheus-operator-cluster-role-binding.yaml example/rbac/nholuongut/prometheus-operator-service-account.yaml example/rbac/nholuongut/prometheus-operator-deployment.yaml
...
Documentation/api.md: $(TYPES_V1_TARGET) $(TYPES_V1ALPHA1_TARGET) $(TYPES_V1BETA1_TARGET)
	GODEBUG=$(GODEBUG) $(API_DOC_GEN_BINARY) -api-dir "github.com/nholuongut/prometheus-operator/pkg/apis/monitoring/" -config "$(PWD)/scripts/docs/config.json" -template-dir "$(PWD)/scripts/docs/templates" -out-file "$(PWD)/Documentation/api.md"
