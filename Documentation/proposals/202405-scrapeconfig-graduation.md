...
* Related Tickets:
  * [Graduate The `ScrapeConfig` CRD To `v1beta1`](https://github.com/nholuongut/prometheus-operator/issues/6697)
* Other docs:
  * [ScrapeConfig Design Proposal](https://github.com/nholuongut/prometheus-operator/blob/main/Documentation/proposals/202212-scrape-config.md)
