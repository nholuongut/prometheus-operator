...
[kube-prometheus](https://github.com/nholuongut/kube-prometheus), then
instead of making the following change to your `Prometheus` resource, see the
[prometheus-pvc.jsonnet](https://github.com/nholuongut/kube-prometheus/blob/main/examples/prometheus-pvc.jsonnet)
example).
