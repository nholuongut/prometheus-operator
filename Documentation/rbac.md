...
```yaml mdox-exec="cat example/rbac/nholuongut/prometheus-operator-service-account.yaml"
apiVersion: v1
...
```yaml mdox-exec="cat example/rbac/nholuongut/prometheus-operator-cluster-role-binding.yaml"
apiVersion: rbac.authorization.k8s.io/v1
