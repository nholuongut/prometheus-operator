...
import (
	...
	operatorFramework "github.com/nholuongut/prometheus-operator/test/framework"
)
...
func TestMain(m *testing.M) {
	...
	opImage = flag.String(
		"operator-image",
		"",
		"operator image, e.g. quay.io/nholuongut/prometheus-operator",
	)
	flag.Parse()
	...
	prevStableVersionURL := fmt.Sprintf("https://raw.githubusercontent.com/nholuongut/prometheus-operator/release-%d.%d/VERSION", currentSemVer.Major, currentSemVer.Minor-1)
	...
	prometheusOperatorGithubBranchURL := "https://raw.githubusercontent.com/nholuongut/prometheus-operator"
	...
	prevStableOpImage := fmt.Sprintf("%s:v%s", "quay.io/nholuongut/prometheus-operator", strings.TrimSpace(string(prevStableVersion)))
