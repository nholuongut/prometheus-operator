...
import (
	...
	"github.com/nholuongut/prometheus-operator/pkg/alertmanager"
	...
	prometheus "github.com/nholuongut/prometheus-operator/pkg/prometheus/server"
	testFramework "github.com/nholuongut/prometheus-operator/test/framework"
)
...
func testPromRemoteWriteWithTLS(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		// Had to change the success flag to True, because prometheus receiver is running in VerifyClientCertIfGiven mode. Details here - https://github.com/nholuongut/prometheus-operator/pull/4337#discussion_r735064646
		{
...
func testPromMultiplePrometheusRulesDifferentNS(t *testing.T) {
	...
	// See https://github.com/nholuongut/prometheus-operator/issues/3847
	for _, file := range ruleFiles {
...
func testPromOnlyUpdatedOnRelevantChanges(t *testing.T) {
	...
	// https://github.com/nholuongut/prometheus-operator/issues/1659). Added here to
...
// github.com/nholuongut/prometheus-operator/pkg/apis/monitoring/v1.PrometheusSpec.ArbitraryFSAccessThroughSMs
