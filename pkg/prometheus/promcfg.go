...
import (
	...
	"github.com/nholuongut/prometheus-operator/internal/util"
	...
	namespacelabeler "github.com/nholuongut/prometheus-operator/pkg/namespacelabeler"
	...
	if len(sc.Spec.DockerSDConfigs) > 0 {
		...
		for i, config := range sc.Spec.DockerSDConfigs {
			...
			if config.MatchFirstNetwork != nil {
				// ref: https://github.com/nholuongut/prometheus/pull/14654
