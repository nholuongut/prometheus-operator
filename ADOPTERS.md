...
Uses [kube-prometheus](https://github.com/nholuongut/kube-prometheus): Yes | No
...
Go ahead and [add your organization](https://github.com/nholuongut/prometheus-operator/edit/main/ADOPTERS.md) to the list.
...
Uses [kube-prometheus](https://github.com/nholuongut/kube-prometheus): Yes
...
Uses [kube-prometheus](https://github.com/nholuongut/kube-prometheus): No
...
Uses [kube-prometheus](https://github.com/nholuongut/kube-prometheus): Yes (with additional tight Giant Swarm integrations)
...
Uses [kube-prometheus](https://github.com/nholuongut/kube-prometheus): Yes (with additional Gitpod mixins)
...
Uses [kube-prometheus](https://github.com/nholuongut/kube-prometheus): Yes (with additional tight OpenShift integrations)
...
The open-source rancher-monitoring Helm chart (based on [kube-prometheus-stack](https://github.com/nholuongut/prometheus-operator/issues)) can be found at [rancher/charts](https://github.com/rancher/charts).
